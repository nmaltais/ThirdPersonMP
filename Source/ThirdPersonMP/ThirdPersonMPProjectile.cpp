...
AThirdPersonMPProjectile::AThirdPersonMPProjectile()
{
    ...
    // With bReplicates set to True, as long as an authoritative copy of the Actor exists on the server, it will try to replicate the Actor to all connected clients.
    bReplicates = true;
    ...
    if (DefaultMesh.Succeeded())
    {
        ...
        StaticMesh->SetRelativeLocation(FVector(0.0f, 0.0f, -15.0f));
